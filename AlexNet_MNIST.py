...
def max_pool(name, l_input):
    return tf.nn.max_pool(l_input, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME', name=name)

def norm(name, l_input):
    return tf.nn.lrn(l_input, depth_radius=4, bias=1.0, alpha=0.001 / 9.0, beta=0.75, name=name)
